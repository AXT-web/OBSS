...
public interface TbBookService {
    ...
    Boolean updatabook(@Param("bookid") Integer bookid, @Param("booktypeid") Integer booktypeid,@Param("bookname") String bookname, @Param("bookpress") String bookpress,@Param("bookpages") Integer bookpages, @Param("bookauthor") String bookauthor,@Param("booktanslor") String booktanslor, @Param("bookprice") Integer bookprice,@Param("bookoutline") String bookoutline, @Param("bookdealmount") Integer bookdealmount,@Param("booklookmount") Integer booklookmount,@Param("bookstoremount") Integer bookstoremount); //用户注册
